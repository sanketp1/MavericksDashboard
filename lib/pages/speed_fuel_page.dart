...
class SppedFuel extends StatefulWidget {
  const SppedFuel({Key? key}) : super(key: key);

  @override
  State<SppedFuel> createState() => _SppedFuelState();
}

class _SppedFuelState extends State<SppedFuel> {
